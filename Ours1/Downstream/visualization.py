...
# from ..Partone.util import adjust_learning_rate
...
def get_all_data_loader(args):
    ...
    _, _, all_label, _, _, all_ground_xy, ground_xy_all_data = obj.data_about()
...
def main():
    ...
    checkpoint = torch.load('../DownstreamOne/SaveModelDT1/ckpt_epoch_xx_bei.pth', map_location='cpu')
